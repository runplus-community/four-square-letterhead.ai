# Four-Square Letterhead (FSL) v1.5 Constitution
...
FSL v1.5 retains the constitutional language, fixed/flexible lanes, traceability, scoped proof and exact release snapshot from v1.4. It simplifies development guidance to one initial sequence and keeps only essential implementation references. The letterhead is not an iteration tracker.
